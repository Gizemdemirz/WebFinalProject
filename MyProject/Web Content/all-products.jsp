					...
					<nav>
						<ul>
							<li><a href="Controller?page=all-products"
								class="list-group-item" style="background: #d6d4d3;"> Tüm
									Ürünler </a></li>
				...
				<div>
					...
					<form action="Controller" method="get"
						...
						<input type="hidden" name="page" value="price-sort"> <input
							type="hidden" name="action" value="all-products"> <select
							name="sort">
						...
						<div class="col-md-4 boyut">
							...
							<div class="text-center">
								<a class="btn btn-primary"
									href="Controller?page=addtocart&action=allproducts&id=<c:out value="${product.getId()}"/>">
									Sepete Ekle </a>
							</div>
							<br>
						</div>
