			...
			<ul>
				...
				<c:choose>
					...
					<c:when test="${session != null}">
						...
						<li><a href="#">Hesabım(<c:out value="${username }"></c:out>)</a></li>
					</c:when>
				</c:choose>
	...
	<div class="unagi-content">
 	<div class="container">
 		<div class="row">
 		      ...
 		      <nav>
 		      <ul>
 		      <li><a href="Controller?page=all-products" class="list-group-item" style="background:  #d6d4d3;">
						    Tüm Ürünler
						  </a></li>
 		      <li> <a href="Controller?page=mobiles" class="list-group-item">Telefon</a></li>
 		      <li><a href="Controller?page=laptops" class="list-group-item">Laptop</a></li>
 		      <li> <a href="Controller?page=clothing" class="list-group-item">Kıyafet</a></li>
 		      <li><a href="Controller?page=home-decor" class="list-group-item">Ev Tekstili</a></li>
 		      </ul>
 		      </nav>
 		      </div>

 				<div ><!-- right -->
 					<h2 style="text-align: center;">Öne Çıkanlar</h2><br>
 					
					<form action="Controller" method="get" style="border: none;margin:40px;padding: 0px;margin-bottom: 20px;">
 					...
 					<c:forEach items="${list }" var="product">
 						...
 						<c:if test="${product.getFeatured() == 'yes' }">
		 					...
		 					<div class="col-md-4 boyut">
		 						...
		 						<div class="text-center">  <a class="btn btn-primary" href="Controller?page=addtocart&action=index&id=<c:out value="${product.getId()}"/>">Sepete Ekle</a> </div><br>
		 					</div>
