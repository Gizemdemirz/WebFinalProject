					...
					<nav>
						<ul>
							...
							<li><a href="Controller?page=laptops"
								class="list-group-item">Laptop</a></li>
							<li><a href="Controller?page=clothing"
								class="list-group-item" style="background: #d6d4d3;">Kıyafet</a></li>
				...
				<div>
					...
					<form action="Controller" method="get"
						...
						<input type="hidden" name="page" value="price-sort"> <input
							type="hidden" name="action" value="clothing"> <select
							name="sort">
					...
					<c:forEach items="${list }" var="product">
						...
						<c:if test="${product.getCategory() == 'clothing' }">
							...
							<div class="col-md-4 boyut">
								...
								<div class="text-center">
									<a class="btn btn-primary"
										href="Controller?page=addtocart&action=clothing&id=<c:out value="${product.getId()}"/>">Sepete
										Ekle</a>
								</div>
								<br>
							</div>
